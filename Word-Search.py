...
MW_DICT_KEY = os.environ.get("MW_DICT_KEY", "YOUR_DICTIONARY_KEY_HERE")
MW_THES_KEY  = os.environ.get("MW_THES_KEY",  "YOUR_THESAURUS_KEY_HERE")
...
def show_dictionary(word: str) -> None:
    ...
    if MW_DICT_KEY == "YOUR_DICTIONARY_KEY_HERE":
...
def show_thesaurus(word: str) -> None:
    ...
    if MW_THES_KEY == "YOUR_THESAURUS_KEY_HERE":
